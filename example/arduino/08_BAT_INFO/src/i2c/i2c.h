...
#include "../gpio/gpio.h"   // GPIO header for pin configuration
...
// Use 100kHz to match the board BSP and improve compatibility for all devices on the shared bus
#define EXAMPLE_I2C_MASTER_FREQUENCY (100 * 1000)

// Define the I2C master port number (I2C_NUM_0 in this case)
#define EXAMPLE_I2C_MASTER_NUM I2C_NUM_0


typedef i2c_master_bus_handle_t DEV_I2C_BusHandle;
typedef i2c_master_dev_handle_t DEV_I2C_DeviceHandle;

typedef struct {
    DEV_I2C_BusHandle bus;
} DEV_I2C_Port;
