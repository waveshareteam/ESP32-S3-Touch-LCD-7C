/**
 * @file user_user_lv_demo_music_list.c
 *
 */
...
LV_IMAGE_DECLARE(user_img_lv_demo_music_btn_list_play);
LV_IMAGE_DECLARE(user_img_lv_demo_music_btn_list_pause);
...
void lv_demo_music_list_button_check(uint32_t track_id, bool state)
{
    ...
    if(state) {
        ...
        lv_image_set_src(icon, &user_img_lv_demo_music_btn_list_pause);
        ...
        lv_image_set_src(icon, &user_img_lv_demo_music_btn_list_play);
    }
}
...
static lv_obj_t * add_list_button(lv_obj_t * parent, uint32_t track_id)
{
    ...
    LV_IMAGE_DECLARE(user_img_lv_demo_music_list_border);
    lv_obj_t * border = lv_image_create(btn);
    lv_image_set_src(border, &user_img_lv_demo_music_list_border);
